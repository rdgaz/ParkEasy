...
public class MainForm : Form
{
    ...
    private Panel CreateDashboardCardsPanel()
    {
        ...
        panel.Controls.Add(cardOccupied,20, 0, 0);
...
public class MainForm : Form
{
    ...
    private Panel CreateStatCard(string title, string initialValue, Color accentColor, out Label valueLabel)
    {
        ...
        var valLbl = Theme.CreateLabel(initialValue, Theme.FontTitle, accentColor);
        valLbl.Location = new Point(14, 32);
        valLbl.Font = Theme.FontHuge;
        card.Controls.Add(valLbl);
    ...
    private Panel CreateActionBarPanel()
    {
        ...
        var btnEntry = Theme.CreateSuccessButton("＋ NOVA ENTRADA (F2)", 200);
        btnEntry.Location = new Point(0, 0);
        btnEntry.Click += (_, _) => OpenEntryForm();
        panel.Controls.Add(btnEntry);

        var btnCheckout = Theme.CreatePrimaryButton("REGISTRAR SAÍDA", 170);
        btnCheckout.Location = new Point(210, 0);
        btnCheckout.BackColor = Theme.Warning;
        btnCheckout.FlatAppearance.MouseOverBackColor = Color.FromArgb(217, 119, 6);
        btnCheckout.Click += (_, _) => OpenCheckoutForSelected();
        panel.Controls.Add(btnCheckout);
        ...
        btnRefresh.Location = new Point(550, 0);
        btnRefresh.Click += async (_, _) => await LoadDataAsync();
        panel.Controls.Add(btnRefresh);

        // Search Input (Right aligned)
        _txtSearch = Theme.CreateInput(240);
        _txtSearch.PlaceholderText = "Pesquisar placa ou cliente (F4)...";
        _txtSearch.CharacterCasing = CharacterCasing.Upper;
        _txtSearch.Location = new Point(panel.Width - 240, 4);
        _txtSearch.Anchor = AnchorStyles.Top | AnchorStyles.Right;
        _txtSearch.TextChanged += async (_, _) => await FilterActiveSessionsAsync();
        panel.Controls.Add(_txtSearch);
    ...
    {
        _gridActive.Columns.Clear();
        _gridActive.Columns.Add(new DataGridViewTextBoxColumn { Name = "Ticket", HeaderText = "Ticket", Width = 100 });
        _gridActive.Columns.Add(new DataGridViewTextBoxColumn { Name = "Placa", HeaderText = "Placa", Width = 110 });
        _gridActive.Columns.Add(new DataGridViewTextBoxColumn { Name = "Modelo", HeaderText = "Modelo", Width = 150 });
        _gridActive.Columns.Add(new DataGridViewTextBoxColumn { Name = "Cliente", HeaderText = "Cliente", Width = 160 });
        _gridActive.Columns.Add(new DataGridViewTextBoxColumn { Name = "Telefone", HeaderText = "Telefone", Width = 130 });
        _gridActive.Columns.Add(new DataGridViewTextBoxColumn { Name = "Entrada", HeaderText = "Horário Entrada", Width = 140 });
        _gridActive.Columns.Add(new DataGridViewTextBoxColumn { Name = "Tempo", HeaderText = "Permanência", Width = 110 });
        _gridActive.Columns.Add(new DataGridViewTextBoxColumn { Name = "ValorEstimado", HeaderText = "Valor Atual", Width = 110 });
        _gridActive.Columns.Add(new DataGridViewTextBoxColumn { Name = "SessionId", Visible = false });
    }
